...
export default function HostelProfile() {
  ...
  const fetchStats = async () => {
    ...
    if (data) {
      setStats({
        total: data.length,
        approved: data.filter((a: any) => a.hostel_verified).length,
        rejected: data.filter((a: any) => a.status === 'rejected' && !a.hostel_verified).length,
      });
    }
  };
  ...
  return (
    <div className="min-h-screen bg-background">
      <DashboardHeader user={{ ...profile, role: 'Hostel Staff' }} title="Profile" />
        ...
        <div className="max-w-4xl mx-auto space-y-6">
          <Card>
            <CardHeader className="flex flex-row items-center justify-between">
              ...
              <Button onClick={() => navigate('/hostel/profile/edit')}>Edit Profile</Button>
            </CardHeader>
            <CardContent>
              <div className="flex items-start gap-6">
                ...
                <div className="grid grid-cols-2 gap-4 flex-1">
                  ...
                  <div>
                    ...
                    <p className="font-medium">Hostel Staff</p>
                  </div>
                  <div>
